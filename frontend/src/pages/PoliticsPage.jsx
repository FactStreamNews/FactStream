  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        ...
        const politicsArticles = articlesWithFormattedDates.filter(articlesWithFormattedDates => articlesWithFormattedDates.category === "politics");
        console.log(politicsArticles);
